            ...
            static publish() {
                ...
                blockly.DialogPublish.open(`
                    ...
                    <p>
                        ...
                        If ou use assets (imgs/sounds) then you may need to build the folder structure for them manually.
                    </p>
            `, (codeHtml));
            }
            static export() {
