...
(function (ha) {
    ...
    (function (blockly) {
        ...
        class Entity {
            ...
            static dbTutName = 'ha.blockly.dataTut';
            static dbAktif = '';
            static list = [];
            static init() {
                try {
                    ...
                    else if (blockly.Store.tutMode) {
                        this.dbAktif = this.dbTutName;
                    }
                    else {
        ...
        class Op {
            ...
            static demo() {
                try {
                    ...
                    // x.open("post", "http://localhost/repo/bblocky/demo.php");
                    // x.onload = (x) => {
                    //     console.log(x);
                    //     console.log((x.currentTarget as XMLHttpRequest).responseText);
                    // }
                    // // let formData: FormData = new FormData();
                    // // formData.append("demo", Entity.getData());
                    // x.send("demo=" + Entity.getData);
                    const body = blockly.Entity.getData();
                    let fd = new FormData();
                    fd.append("body", body);
                    fd.append("dev", blockly.Store.devMode + '');
                    fd.append("tut", blockly.Store.tutMode + '');
