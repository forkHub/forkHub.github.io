...
function lingkaranKe(cx, cy, sweepAngleDeg, clockWise = false) {
    const r = Math.sqrt(Math.pow((G.lastX - cx), 2) + Math.pow((G.lastY - cy), 2));
...
function polygonTeratur(x, y, radius, sides) {
    if (sides < 3)
        return;
...
function warna(idx = 0, trans = 100) {
    Basik.Warna.warna(idx, trans);
}
function warnaGaris(idx, trans = 100) {
...
function mouseDragX() {
    var _a;
    return (_a = In.getDraggedInput()) === null || _a === void 0 ? void 0 : _a.xDrag;
}
function mouseDragY() {
    var _a;
    return (_a = In.getDraggedInput()) === null || _a === void 0 ? void 0 : _a.yDrag;
}
function mouseX() {
    var _a;
    return (_a = In.global) === null || _a === void 0 ? void 0 : _a.x;
}
function mouseY() {
    var _a;
    return (_a = In.global) === null || _a === void 0 ? void 0 : _a.y;
}
function mouseDragAwalX() {
    var _a;
    return (_a = In.getDraggedInput()) === null || _a === void 0 ? void 0 : _a.xStart;
}
function mouseDragAwalY() {
    var _a;
    return (_a = In.getDraggedInput()) === null || _a === void 0 ? void 0 : _a.yStart;
}
...
function jarak(x = 0, y = 0) {
    return Math.hypot(x, y);
}
function jarakSudut(angleS = 0, angleT, min = true) {
...
function normalisasiSudut(sdt = 0) {
    let n = sdt % 360;
    if (n < 0) {
        n += 360;
    }
...
function pembulatan(n, b = 1, type = 0) {
    if (type == 1) {
...
function muatAnimasi(url, fw = 32, fh = 32) {
...
function posisiGambar(img, x = 0, y = 0) {
    img.x = x;
    img.y = y;
}
function ukuranGambar(img, p = 32, l = 32) {
    img.panjang = p;
    img.lebar = l;
}
function pusatGambar(img, x = 0, y = 0) {
    img.pusatX = x;
    img.pusatY = y;
}
